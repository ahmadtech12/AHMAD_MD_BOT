...
global.owner = process.env.OWNER_NUMBER || '94760310266' ; // Add Your Number without +
...
global.github = 'https://github.com/maduwa2006/SIGMA-MD' ;
...
module.exports = {
  ...
  ownername:  process.env.OWNER_NAME || `Sahan Maduwantha`, // add your name
  ...
  caption :process.env.CAPTION || "\t*⤹★ᴘᴏᴡᴇʀᴇᴅ ʙʏ★⤸ Sahan* ",   //*『sᴜʙsᴄʀɪʙᴇ • ɪɴɴᴏxᴇɴᴛ ᴛᴇᴄʜ』https://www.youtube.com/@InnoxentTech,
