...
global.owner = process.env.OWNER_NUMBER  || '+2347038308662' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "2347038308662" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '22_03_2024_SIGMA_MD_jrdRnqKA_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'Lilpresh-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Lil Presh`, // ADD YOUR NAME
  ...
  caption :process.env.CAPTION || "*• ѕιgмα-м∂ мυℓтι-∂єνι¢є*\n*• ωнαтѕαρρ вσт* by lil presh ",
  LANG: process.env.THEME || "PRESH_MD",
