...
global.owner = process.env.OWNER_NUMBER || '923437694013' ; // Add Your Number without +
...
global.mztit = process.env.MZTIT ||"*✭𓅃ₛₐⱼᵢdੌ♥️*", // add your title here
global.Gname = process.env.GNAME ||"*✭𓅃ₛₐⱼᵢdੌ♥️*",
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || '*✭𓅃ₛₐⱼᵢdੌ♥️*',  // add the botname you want
  ownername:  process.env.OWNER_NAME || `*✭𓅃ₛₐⱼᵢdੌ♥️*`, // add your name
  ...
  caption :process.env.CAPTION || "\t*⤹*✭𓅃ₛₐⱼᵢdੌ♥️* ",   //*『*✭𓅃ₛₐⱼᵢdੌ♥️* • ɪɴɴᴏxᴇɴᴛ ᴛᴇᴄʜ』https://www.youtube.com/@InnoxentTech,
