...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || '🅂🄸🄶🄼🄰 🄼🄳,         // ADD YOUR BOT NAME
  ...
  packname:  process.env.PACK_NAME  || "🄵🄰🄷🄰🄳" ,          // ADD YOUR STICKER PACKNAME
  ...
  warncount : process.env.WARN_COUNT || 900,                 // WARN LIMITS
  ...
  promote_demote_messages : process.env.PROMOTE_DEMOTE_MESSAGES || 'ture' ,     // IF TRUE IT WILL SEND AN ALERT MESSAGE WHEN SOMEONE PROMOTED/DEMOTED IN GROUPS
