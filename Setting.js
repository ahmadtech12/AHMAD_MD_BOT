...
global.owner = process.env.OWNER_NUMBER  || '923417680053' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "923417680053" ;          // DON'T REMOVE
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'DEVELOPER',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `DEVELOPER`, // ADD YOUR NAME
  ...
  caption :process.env.CAPTION || "\t*DEVELOPER* ",
